...
<p style={{display: 'flex', gap: '0.5rem'}}> <RssIcon /> <a href="https://feedly.com/i/subscription/feed/https://kuizuo.cn/rss.xml" target="_blank">RSS</a></p>

<p style={{display: 'flex', gap: '0.5rem'}}> <GithubIcon /> <a href="https://github.com/kuizuo" target="_blank">Github</a></p>

<p style={{display: 'flex', gap: '0.5rem'}}> <QqIcon /> <a href="http://wpa.qq.com/msgrd?v=3&uin=911993023&site=qq&menu=yes" target="_blank">QQ</a></p>

<p style={{display: 'flex', gap: '0.5rem'}}> <TwitterIcon /> <a href="https://twitter.com/kuizuo" target="_blank">Twitter</a></p>

<p style={{display: 'flex', gap: '0.5rem'}}> <EmailIcon /> <a href="mailto:hi@kuizuo.cn" target="_blank">hi@kuizuo.cn</a></p>
